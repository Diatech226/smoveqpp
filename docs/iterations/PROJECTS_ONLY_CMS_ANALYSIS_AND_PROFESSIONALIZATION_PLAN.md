...
### P1 outcomes
- Media roles are authoritative for card/hero/gallery/social resolution, with legacy field compatibility retained.
...
- Internal mapping clarity between CMS fields and public surfaces is documented.
